...
<article>
	...
	<div class="Withdrawalwrap">
		<div class="p-5" style="text-align: right; width: 45%;">
			...
			<form class="user" action="login.jsp" name="login" method="post">
				...
				<input type="submit" value="취소" style="width:20%; 
						background: gray;border-color: gray;"
						class="btn btn-primary btn-user" onclick='btn_("cancel")'>
				<input type="submit" value="확인" style="width:20%"
					class="btn btn-primary btn-user" onclick='btn_("commit")'>
			</form>
			<hr>
		</div>
