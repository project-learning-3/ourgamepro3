                        ...
                        <div class="p-5">
                            ...
                            <input type="hidden" name="no" value="<%=2%>">                 	
								<div class="form-group">
									<a id="test_btn1" href="register1.jsp" class="btn btn-primary btn-user">for member</a>
                                ...
                                <div class="form-group" id="bn">
                                    <input type="number" class="form-control form-control-user" id="businessNumber"
                                            placeholder="Business Number" name="businessNo">
                                </div>
