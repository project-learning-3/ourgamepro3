    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Goodgame <sup>Gg</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse"  aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded" >
                        ...
                        style="text-decoration:none"><h6 class="collapse-header" style="font-size: 13px;">장르</h6></a>
                        ...
                        <div class="bg-white py-2 collapse-inner rounded" >
                        <a href="#" data-toggle="collapse" data-target="#collapsePages1_2"
                        style="text-decoration:none"><h6 class="collapse-header" style="font-size: 13px;">추천 게임</h6></a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">[아이디]님의 계정</h6><!-- 로그인 하면 이름 나오게 -->
                        <a class="collapse-item" href="">환경 설정</a> <!-- 환경설정 페이지 나오게 -->
                        <a class="collapse-item" href="cards.html">쿠키 및 검색</a> <!-- 쿠키 값 가져오자 -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">[아이디] 님, 무엇을 도와드릴까요?</h6>
                        <a class="collapse-item" id="CSupport1" href="utilities-color.html">고객지원</a>
                        <div id="CSupport2">
                           <div><a class="collapse-item" href="blank.html">게임,소프트웨어,기타</a></div>
                           <div><a class="collapse-item" href="blank.html">구매</a></div>
                           <div><a class="collapse-item" href="blank.html">나의계정</a></div>
                           <div><a class="collapse-item" href="blank.html">포인트</a></div>
                        </div>
<!--이용약관 html만 만듭시다--> <a class="collapse-item" href="utilities-border.html">이용약관</a> <!-- 이용약관 만들어주게 -->
                        <a class="collapse-item" href="utilities-animation.html">시스템정보</a> <!-- 컴퓨터 사양나오게 둘 다--> 
                        <a class="collapse-item" href="utilities-other.html">[증기]정보</a> <!-- 이건 대충 창으로--> 
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseuser" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="blank.html">프로필 수정</a> <!-- 계정변경 html로 연결 -->
                        <a class="collapse-item" href="blank.html">프로필 정보</a>
                        <a class="collapse-item1" href="login.html">로그아웃</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><%=re %></span>
