                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
							...
							<form class="user" action="withdraw_ok.jsp" name="withdraw"
								method="post">
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="password" class="form-control form-control-user"
											id="exampleInputPassword" name="d_pwd" placeholder="비밀번호">
									</div>
									<div class="col-sm-6">
										<input type="password" class="form-control form-control-user"
								...
								<div class="form-group">
									<input type="text" class="form-control form-control-user"
										id="chargeMoney" name="c_money" placeholder="인출금액">
								</div>
           							 <input type="submit" value="인출하기" class="btn btn-primary btn-user btn-block" onclick="regbtn()">
