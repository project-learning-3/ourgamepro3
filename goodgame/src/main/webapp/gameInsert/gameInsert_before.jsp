					...
					<div class="col-lg-7">
						<div class="p-5">
							<div class="text-center">
								<h1 class="h4 text-gray-900 mb-4">게임등록약관</h1>
							</div>
							<form class="user">
								<div class="form-group">
									<pre class="agreement">
Good game 게임등록하기 (개발자)

Good game에 게임을 등록하고 판매합니다.
온라인게임 표준약관
표준약관 제10069호
(2014.9.19. 개정)
...
제1조 (목적) 이 약관은 Good game(이하 “회사”)가 온라인으로 제공하는 게임 및 이에 부수된 제반 서비스(이하 “게임서비스”)의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
제34조 (재판권 및 준거법) 본 약관은 대한민국 법률에 따라 규율되고 해석되며, 회사와 회원간에 발생한 분쟁으로 소송이 제기되는 경우, 법령에 정한 절차에 따른 법원을 관할 법원으로 합니다.
								...
								<!-- 테스트 -->
								<a id="regbtn" href="gameInsert.jsp"
									class="btn btn-primary btn-user btn-block"> 동의합니다 </a>
